...
import com.jiangdg.ausbc.callback.IAudioRawDataCallBack
 ...
 */
class AACEncodeProcessor(val ctrlBlock: USBMonitor.UsbControlBlock? = null) : AbstractProcessor() {
    ...
    /** 原始音频回调 */
    private var mPcmCallback: IAudioRawDataCallBack? = null
     ...
     * @param cb 回调函数
     */
    fun setPcmCallback(cb: IAudioRawDataCallBack) {
        mPcmCallback = cb
    }
    ...
    private fun initAudioRecord() {
        ...
        mAudioThreadPool.submit {
            ...
            while (mAudioRecordState.get()) {
                ...
                data ?: continue
                // pcm raw callback
                mPcmCallback?.pcmData(data.data.copyOfRange(0, data.size))
                // pcm encode queue
    ...
    private fun initAudioTrack() {
        ...
        val minBufferSize = AudioTrack.getMinBufferSize(
            sampleRate, CHANNEL_OUT_CONFIG, rateResolution
        )
